...
export default function PathGambling({ stats, onUpdateStats, onFinish }: PathGamblingProps) {
    ...
    <div className="max-w-xl mx-auto px-4 py-8 space-y-6">
      ...
      {step === 'store_entry' && (
        ...
        >
          ...
          <p className="text-slate-300 text-sm leading-relaxed">
            Walking past the local neon-lit <strong>Lucky Express Store</strong>, Leo sees a bright, moving signs in the storefront:
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-2">
            <button
              ...
              className="p-4 rounded-xl border border-slate-800 hover:border-amber-500 hover:bg-slate-850/40 text-left transition-all cursor-pointer group space-y-1"
            >
            ...
            >
              <div className="font-bold text-slate-100 group-hover:text-rose-400 text-sm flex items-center justify-between">
                <span>🔥 Go ALL IN! (50 Tickets for $500)</span>
                <span className="text-[9px] bg-rose-950 text-rose-400 px-1.5 py-0.5 rounded uppercase font-mono font-bold">PSYCHOTIC</span>
              </div>
        ...
        >
          ...
          <div className="max-w-md mx-auto bg-slate-955 p-4 rounded-xl border border-slate-850 space-y-3 text-left">
            <p className="text-xs text-slate-350 leading-relaxed">
              Every single ticket was a dud. Staring down, Leo sees raw empty spaces in the scratch boxes. The trash can is filled with worthless curled silver-grey paper.
            </p>
      ...
      {step === 'trap_victory' && (
        ...
        >
          ...
          <div className="max-w-md mx-auto bg-slate-955 p-4 rounded-xl border border-slate-850 space-y-3 text-left">
            <p className="text-xs text-slate-350 leading-relaxed">
              Leo's eyes expand. A MATCH OF SEVENS! A massive rush of dopamine hits his amygdala. He doubled his $10 ticket into a $20 prize payout!
            </p>
