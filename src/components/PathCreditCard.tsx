...
export default function PathCreditCard({ stats, onUpdateStats, onFinish }: PathCreditCardProps) {
    ...
    <div className="max-w-xl mx-auto px-4 py-8 space-y-6">
      ...
      {step === 'choose_card' && (
        ...
        >
          ...
          <p className="text-slate-300 text-sm leading-relaxed">
            Leo wants to buy a laptop immediately for <strong>$600</strong>, but he only has $500 cash in hand. He searches online for credit card options to bridge the gap.
          </p>
          ...
          <div className="grid grid-cols-1 gap-4 pt-2">
            ...
            <button
              ...
              className="p-5 rounded-2xl border border-slate-800 hover:border-emerald-500 hover:bg-slate-800/40 text-left transition-all cursor-pointer group space-y-2 bg-emerald-950/5"
            >
              <div className="flex justify-between items-center">
                <span className="font-bold text-slate-100 group-hover:text-emerald-400 text-sm flex items-center gap-1.5">
                  📁 Student Secured Credit Card
                </span>
                <span className="text-[9px] font-mono px-1.5 py-0.5 bg-emerald-950 text-emerald-400 rounded uppercase font-semibold">SAFE</span>
              </div>
              <p className="text-xs text-slate-400 leading-relaxed">
                Requires placing a <strong>$300 security deposit</strong> (held by the bank). In return, you get a strict <strong>$300 spending limit</strong>. Excellent for building credit with zero risk of catastrophic overspending.
              </p>
            ...
            <button
              ...
              className="p-5 rounded-2xl border border-slate-800 hover:border-rose-500 hover:bg-slate-800/40 text-left transition-all cursor-pointer group space-y-2 bg-rose-950/5"
            >
              <div className="flex justify-between items-center">
                <span className="font-bold text-slate-100 group-hover:text-rose-400 text-sm flex items-center gap-1.5">
                  💳 Premium "Aura Gold" Credit Card
                </span>
                <span className="text-[9px] font-mono px-1.5 py-0.5 bg-rose-950 text-rose-400 rounded uppercase font-semibold">TRAP RISK</span>
              </div>
              <p className="text-xs text-slate-400 leading-relaxed">
                Promises a high <strong>$1,000 credit limit</strong> instantly without a security deposit! However, carrying a balance incurs <strong>29.9% APR (annual percentage rate)</strong> penalty interest.
              </p>
              <div className="text-[10px] font-mono text-slate-500 flex gap-4">
                <span>LIMIT: $1,000</span>
                <span>DEPOSIT: $0</span>
                <span className="text-rose-400 font-bold">APR: 29.9%</span>
              </div>
            </button>
      ...
      {step === 'laptop_purchase' && (
        ...
        >
          ...
          <p className="text-slate-300 text-sm leading-relaxed">
            Leo swipes his newly approved credit card over the modern checkout counter.
          </p>
            ...
            <div className="space-y-2">
              ...
              <p className="text-slate-400 text-xs">
                {selectedCard === 'secured' ? (
                  'Because the Secured Card has a $300 limit, Leo cannot afford the $600 model. Instead, he plays it smart and buys a Refurbished Student laptop for $250! He has perfect utility with $50 remaining credit room.'
                ) : (
                  'With a $1,000 credit card limit, Leo buys the top-tier $600 brand-new Gaming computer! He only pays $0 out of pocket at checkout today, carrying $600 credit debt on the card statement.'
                )}
              </p>
            </div>
      ...
      {step === 'billing' && (
        ...
        >
          ...
          <p className="text-slate-300 text-sm leading-relaxed">
            One month later, the credit card statement pinged Leo's email inbox. He owes a total of <strong>${debtAmount}</strong>. It's time to choose a payments structure.
          </p>
            ...
            {selectedCard === 'secured' ? (
              ...
              >
                <div className="font-bold text-slate-100 group-hover:text-emerald-400 text-sm">
                  Pay Full Balance ($250)
                </div>
                <p className="text-xs text-slate-400 mt-1 leading-normal">
                  Leo has $500 cash in hand. He pays the full $250 credit bill. Card drops back to $0 debt. He pays exactly $0 in interest fees, keeping his wallet secure.
                </p>
              </button>
            ) : (
              <>
                ...
                <button
                  disabled
                  title="Leo only has $500 cash and cannot afford to pay the full $600 balance!"
                ...
                >
                  ...
                  <p className="text-xs text-slate-600 mt-1 leading-normal">
                    Leo cannot select this. The statement balance ($600) is higher than his entire checking cash wallet ($500). This is the risk of spending beyond your cash holdings!
                  </p>
                </button>
              </>
            )}
              ...
              {selectedCard === 'secured' ? (
                <div className="space-y-1.5">
                  ...
                  <p className="text-xs text-slate-300 leading-normal">
                    Leo cleared his balance and built superb historical credit consistency. He paid <strong>$0 in interest fees</strong> and sleeps soundly knowing his credit score is skyrocketing!
                  </p>
                </div>
              ) : (
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-slate-300 leading-normal">
                    Leo paid a total of <strong>${billChoice === 'minimum' ? '$150' : '$480'}</strong> over six months. However, because of the 29.9% APR, his laptop is costing him immense compounding fees and his balance is still outstanding at <strong className="text-rose-400">${timelineData.endingDebt}</strong>! His debt barely budged.
                  </p>
                </div>
              )}
            </div>
