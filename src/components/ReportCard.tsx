...
export default function ReportCard({ stats, pathExplanation, onRestart }: ReportCardProps) {
  ...
  const getPersona = () => {
    if (stats.cash === 0 && stats.debt > 0 && stats.happiness <= 20) {
      return {
        ...
        tag: 'DANGER ZONE',
        desc: 'Oh dear. Leo is heavily bogged down by double-digit interest rates and penalty overdraft additions. Repayments eat his daily paycheck before he even wakes up.',
      ...
      return {
        ...
        tag: 'MASTER CLASS',
        desc: 'Leo opened checks, established reliable credit using security deposits, and kept spending securely within his cash limits! Magnificent budgeting form.',
      ...
      return {
        ...
        tag: 'BNPL TRAPPED',
        desc: "Overdrafted by stacking invisible installments. Leo bought into easy buy-now buttons only to be struck down by payday's automatic drafts.",
      ...
      return {
        ...
        desc: 'Leo avoided dangerous traps and carries minor risk, though there is room to streamline compounding strategies and secured credit limits.',
    ...
    <div className="max-w-2xl mx-auto px-4 py-8 space-y-8 select-none">
      ...
      >
        ...
        <div className="space-y-2.5 relative z-10 flex flex-col items-center">
          ...
          <span className="font-mono text-indigo-400 font-black uppercase tracking-widest text-[11px]">Leo's Payday Crossroads Completion</span>
        ...
        <div className={`p-6 rounded-2xl border-2 text-left space-y-3.5 ${persona.color}`}>
          <div className="flex justify-between items-center">
            <span className="font-mono text-[10px] uppercase font-black text-slate-400">LEO'S FINANCIAL PERSONA:</span>
      ...
      <div className="space-y-4 text-left">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-5 rounded-2xl bg-slate-900 border-2 border-slate-800 flex gap-4">
            <div className="p-3 bg-indigo-505/10 bg-indigo-500/10 text-indigo-400 h-11 w-11 rounded-lg shrink-0 flex items-center justify-center bg-indigo-950">
              <CreditCard size={20} />
            </div>
      ...
      <div className="flex flex-col items-center pt-2">
        ...
        <span className="text-[10px] text-slate-500 font-mono mt-3.5 uppercase tracking-widest font-bold">
          Replay paths to optimize Leo's ledger scores!
        </span>
      </div>
