...
export default function PathBNPL({ stats, onUpdateStats, onFinish }: PathBNPLProps) {
  ...
  const handleAgreeBNPL = () => {
    ...
    onUpdateStats(prev => ({
      ...
      happiness: Math.min(100, prev.happiness + 20) // Leo feels immediate shopping happiness dopamine spike!
    }));
  ...
  const handleResolveCollision = () => {
    ...
    // Leo's remaining paycheck was: $500 - totalBnplToday
    ...
    const fees = 105;
    const itemsLoss = totalBill - totalBnplToday; // the rest of the debt Leo owes
    ...
    onFinish(`Fell for the 'Buy Now, Pay Later' (BNPL) trap by stacking 3 separate split-repayments. Staggering monthly automatic transactions hit his checking account simultaneously next month, overdrafting his account. Face three separate $35 overdraft fees ($105 total penalty), driving his total liabilities is negative.`);
  };
    ...
    <div className="max-w-xl mx-auto px-4 py-8 space-y-6">
      ...
      {step === 'storefront' && (
        ...
        >
          <div className="flex items-center space-x-3 text-amber-500">
            <ShoppingBag size={28} />
            <h2 className="text-lg font-bold">Scene 1: Leo Browses Online</h2>
          </div>

          <p className="text-slate-300 text-sm leading-relaxed">
            Relaxing in his bedroom with your paycheck cash safely stashed, Leo goes online to buy clothes and gear he has been eyeing.
          </p>
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-850 space-y-1 text-xs">
            ...
            <div className="flex justify-between font-mono font-bold">
              <span className="text-amber-500 uppercase tracking-widest text-[10px]">BNPL checkout price Today:</span>
              <span className="text-amber-400 text-sm">${totalBnplToday} today</span>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full py-4 bg-amber-500 hover:bg-amber-600 text-slate-950 font-bold rounded-xl text-sm transition-transform cursor-pointer text-center"
          >
      ...
      {step === 'checkout' && (
        ...
        >
          ...
          <p className="text-slate-300 text-sm leading-relaxed">
            Leo clicks purchase. An aggressive checkout wizard overrides the standard credit card options:
          </p>
          ...
          <div className="bg-gradient-to-r from-amber-500/10 to-orange-500/5 border border-amber-500/20 p-5 rounded-2xl text-center space-y-3">
            <h3 className="font-mono text-xs uppercase tracking-widest text-amber-500 font-black">💳 Split-Pay Premium BNPL</h3>
            ...
            <p className="text-slate-400 text-xs text-justify">
              "Why pay <strong>${totalBill}</strong> up front when you can split it into 4 small monthly drafts? No hidden credit checks. Zero impact on credit. Live comfortable. Buy everything today!"
            </p>
          </div>
          ...
          <div className="p-3 bg-slate-950 rounded-xl border border-slate-900 text-[11px] text-slate-400 flex items-start gap-2.5 leading-relaxed">
            ...
            <span>
              <strong>The Trap:</strong> BNPL plans feel cheap because of micro-repayments. But stacking 3 separate plans commits Leo to high monthly overheads. He doesn't notice his savings draining away.
            </span>
          </div>
          ...
          <div className="grid grid-cols-1 gap-2">
            ...
            >
              👍 Agree & Sign up for BNPL: Pay ${totalBnplToday} right now
            </button>
          </div>
        </motion.div>
      )}
      ...
      {step === 'month_collision' && (
        ...
        >
          ...
          <p className="text-slate-350 text-xs leading-relaxed">
            Initially, Leo gets his items and feels a massive shopping high! However, next month, he forgets about the multiple payment plans he authorized.
          </p>
          ...
          <div className="bg-slate-950 rounded-xl p-4 border border-slate-850 space-y-4">
            <div className="flex justify-between items-center text-xs font-mono text-slate-500">
              ...
              <strong className="text-rose-450 uppercase animate-pulse">Pending Drafts</strong>
            </div>
            ...
            <div className="space-y-1.5 font-mono text-xs">
              <div className="flex justify-between text-slate-550">
                <span>Leo's Current Account Cash reserves:</span>
                <strong>+$100</strong>
              </div>
            ...
            <div className="flex gap-2 items-start">
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-400 mt-0.5 leading-relaxed">
                  Because BNPL repayments draft separately, 3 individual transactions bounce on empty balances. The bank logs three separate <strong>$35 Overdraft Fees</strong>!
                </p>
              </div>
            </div>
