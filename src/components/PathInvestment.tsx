...
export default function PathInvestment({ stats, onUpdateStats, onFinish }: PathInvestmentProps) {
      ...
      {step === 'study_room' && (
        ...
        >
          ...
          <p className="text-slate-300 text-sm leading-relaxed">
            Leo pulls a chair next to his sister **Maya**, an economics Ph.D student. She sits surrounded by graphs and thick finance volumes.
          </p>
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-850 text-xs italic text-slate-400 relative">
            ...
            "Hey buddy! Proud of your paycheck! If you keep cash in a drawer, inflation eats 3% of your spending power every single year. You need your money working for you through index compounding, not sitting idle. Just avoid speculative hype circles."
          </div>
          ...
          <div className="grid grid-cols-1 gap-3 pt-2">
            <button
              ...
              className="p-4 rounded-xl border border-emerald-500/30 hover:border-emerald-500 hover:bg-slate-850/40 text-left transition-all cursor-pointer group space-y-1 bg-emerald-950/5"
            >
              <div className="font-bold text-slate-200 group-hover:text-emerald-400 text-sm flex justify-between items-center">
                <span>📁 Diversified Index Fund</span>
                <span className="text-[9px] font-mono px-1.5 py-0.5 bg-emerald-950 text-emerald-400 rounded">SAFE GROWTH</span>
              </div>
              <p className="text-xs text-slate-400">
                Put $500 in low-fee index funds mirroring the broader economic markets. Compiles stable 8-10% average annual composite interest.
              </p>
            </button>
            ...
            <button
              ...
              className="p-4 rounded-xl border border-rose-500/30 hover:border-rose-500 hover:bg-rose-950/20 text-left transition-all cursor-pointer group space-y-1 bg-rose-950/5"
            >
              <div className="font-bold text-slate-200 group-hover:text-rose-450 text-sm flex justify-between items-center">
                <span>🚀 "Doge-Rocket-Inu" Meme Token</span>
                <span className="text-[9px] font-mono px-1.5 py-0.5 bg-rose-950 text-rose-400 rounded">SPECULATIVE TRAP</span>
              </div>
              <p className="text-xs text-slate-400">
      ...
      {step === 'crypto_crash' && (
        ...
        >
          ...
          <p className="text-slate-300 text-sm max-w-sm mx-auto leading-relaxed">
            Exactly 6.3 seconds later, the major liquidity creators and founders sold out all their tokens at peak pricing. DRI crashed in a vertical red line. The swap app has frozen withdrawals. Leo’s balance is effectively gone.
          </p>
      ...
      {step === 'index_simulator' && (
        ...
        >
          ...
          <p className="text-slate-300 text-xs leading-normal">
            Leo feeds his initial $500 lump paycheck into the world index, expanding steadily at an <strong>8% average annual return</strong> compounded. Adjust the timeline and monthly allocations below.
          </p>
          ...
          <div className="bg-slate-950 p-5 rounded-xl border border-slate-850 space-y-4">
            ...
            <div className="text-[10px] text-slate-400 leading-relaxed text-center italic bg-slate-900/30 p-2 border border-slate-900 rounded">
              "Through the magic of <strong>Compound Interest</strong>, Leo's money doesn't just grow. His earned interest begins generating its own interest, fueling an exponential compounding curving line!"
            </div>
          </div>
